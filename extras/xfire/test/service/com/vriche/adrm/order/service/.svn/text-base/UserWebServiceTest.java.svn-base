package com.vriche.adrm.order.service;
...
import com.vriche.adrm.order.dao.UserDao;
...
public class UserWebServiceTest extends AbstractXFireSpringTest {
    ...
    public void testGetUser() throws Exception {
        ...
        // invoke webservice
        Document response =
            invokeService("UserWebService", "/com/vriche/adrm/order/service/getUser.xml");
    ...
    protected ApplicationContext createContext() {
        return new ClassPathXmlApplicationContext(new String[]{
                "com/vriche/adrm/order/service/applicationContext-test.xml",
                "com/vriche/adrm/order/service/applicationContext-webservice.xml"});
    }
