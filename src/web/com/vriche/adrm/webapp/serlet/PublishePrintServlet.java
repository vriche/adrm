 ...
 */
public class PublishePrintServlet extends HttpServlet
{
	  /**
	 * 
	 */
...
//	        System.out.println(">>>>>>publishDate>>>>>" +publishDate);
	        ...
	        Collection coll = mgr.getPublishedInfosByHistoryColl(resourceIds,publishDate);
...
//		System.out.println(">>>>>org>>>>>>" +org.getName());
		...
		File reportFile = new File(context.getRealPath(reportsTemplePath +"publish_report.jasper"));
		...
		parameters.put("ReportTitle", org.getReportTitle()+ carrierName +"¹ã¸æ±à²¥µ¥");
