 ...
 */
public class CustomerIncomeMoneyServlet extends HttpServlet
{
	  /**
	 * 
	 */
...
//	private static final String CONTENT_TYPE = "text/html; charset=GBK";
	...
	public void service(HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException
	{
			  ...
			  String userId=  (String)session.getAttribute("userOwner");
			  String arrears = (String)session.getAttribute("arrears");
			  String purpose = (String)session.getAttribute("incomepurpose");
			  ...
			  String[] pIds = purpose.split(",");
				Map parameters = new HashMap();				
				//设置标题
				parameters.put("ReportTitle",  "公司进款统计");
...
//	        System.out.println(">>>>>incomepurpose>>>>>>" +purpose);

	       
	        
	     Collection coll = getCustomerIncomeMoneyForPrint(orgId,putYear,usrName,channelModelParam,customerId,carrierId,userId,startDate,endDate,pIds,arrears);
		...
		File reportFile = new File(context.getRealPath(reportsTemplePath +"customerIncomeMoney_report.jasper"));
...
//		                     out.println("bytes were null!");  
	...
	public Collection getCustomerIncomeMoneyForPrint(String orgId,String putYear,String usrName,String channelModelParam,String customerId,String carrierId,String userId,String startDate,String endDate,String[] purpose,String arrears){
		...
		List ls = mgr.getCustomerIncomeMoneyList(orgId,putYear,usrName,channelModel,customerId,carrierId,userId,startDate,endDate,purpose,arrears);
