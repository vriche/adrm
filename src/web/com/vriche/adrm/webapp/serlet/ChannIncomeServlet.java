 ...
 */
public class ChannIncomeServlet extends HttpServlet
{
	  /**
	 * 
	 */
...
//	private static final String CONTENT_TYPE = "text/html; charset=GBK";
	...
	public void service(HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException
	{
			  ...
			  String carrierId = (String)session.getAttribute("carrierName");
			  ...
			  String        model=  (String)session.getAttribute("model");
				...
				//设置标题
				parameters.put("ReportTitle",  "频道进款统计");
...
//	        System.out.println(">>>>>>carrierId>>>>>" +carrierId);
	        ...
	        Collection coll = getChannelIncomeForPrint(orgId,startDate,endDate,customerId,carrierId,channelModelParam,userName, isPutYear, isNotReturnValue, purpose,userId);
...
//		                     out.println("bytes were null!");  
	...
	public Collection getChannelIncomeForPrint(String orgId,String beginDate, String endDate,String customerId,String carrierId,String channelModelParam,String userName,String isPutYear,String isNotReturnValue,String purpose,String userId){
		
		IncomeUsedManager mgr = (IncomeUsedManager) getBean("incomeUsedManager");
		
		Collection coll = new ArrayList();
		int channelMode =Integer.parseInt(channelModelParam);
		List ls = mgr.getChannelIncomeList(orgId,beginDate,endDate,customerId,carrierId,channelMode,userName, isPutYear, isNotReturnValue, purpose,userId);
	    for(Iterator it = ls.iterator();it.hasNext();){
			IncomeUsed used = (IncomeUsed)it.next();
			IncomeUsed newUsed = new IncomeUsed();
			newUsed.setCarrierName(used.getIncomePublic().getCarrierName());
			newUsed.setIncomeMoney(used.getIncomePublic().getIncomeMoney());
			String usedMoney = used.getIncomePublic().getUsedMoney()==null?"0":used.getIncomePublic().getUsedMoney();
			newUsed.setMoneyIn(new Double(usedMoney));
			coll.add(newUsed);
		}
	    	return coll;
	    }
