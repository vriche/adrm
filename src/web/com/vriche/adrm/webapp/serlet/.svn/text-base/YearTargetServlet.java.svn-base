 ...
 */
public class YearTargetServlet extends HttpServlet
{
	  /**
	 * 
	 */
...
//	private static final String CONTENT_TYPE = "text/html; charset=GBK";
	...
	public void service(HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException
	{
			  ...
			  String carrierId = (String)session.getAttribute("carrierIdForm");
			  ...
			  String  model=  (String)session.getAttribute("model");
				...
				//设置标题
//				parameters.put("ReportTitle",  "年度对比统计");
				
			
			
	        Collection coll = getYearTargetForPrint(type,size,carrierId,channelModelParam,userName,isPutYear,isNotReturnValue,purpose);
//	        Collection coll = getYearTargetForPrint2(alias,type,size,carrierId,channelModelParam,userName,isPutYear,isNotReturnValue,purpose);
//		ServletContext context = this.getServletConfig().getServletContext();
//		
//		String fileSep = Constants.FILE_SEP;
//		String reportsTemplePath = fileSep + "reports" + fileSep +"template" +fileSep;
//
//		File reportFile = new File(context.getRealPath(reportsTemplePath +"channaIncome_report.jasper"));
//		
//		
//				
...
//				(String reportType,String titl,String[] headers, String alias[],String[] displaySumColum,boolean isSum,boolean isVertical)
				
				JasperReport jasperReport = JasperReportUtil.getJasperReport("reportType","年度对比统计",headers,alias,displaySumColum.split(","),true,true);
...
//		                     out.println("bytes were null!");  
	...
	public Collection getYearTargetForPrint(String type, String size,String carrierId,String channelModelParam,String userName,String isPutYear,String isNotReturnValue,String purpose){
		...
		List ls = mgr.getYearTargetAnalyze(size1,type,carrierId,channelMode,userName,isPutYear,isNotReturnValue,purpose);
...
//public Collection getYearTargetForPrint2(String[] headers,String type, String size,String carrierId,String channelModelParam,String userName,String isPutYear,String isNotReturnValue,String purpose){
//		
//		FinanceTargetManager mgr = (FinanceTargetManager) getBean("financeTargetManager");
//		int channelMode =Integer.parseInt(channelModelParam);
//		int size1 =Integer.parseInt(size);
...
//		Collection coll =  JasperReportUtil.getBaseList2Collection(headers, ls,fTarget);
//		
//		return coll;	
//}
