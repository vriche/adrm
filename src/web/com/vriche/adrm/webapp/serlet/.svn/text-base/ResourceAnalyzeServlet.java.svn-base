 ...
 */
public class ResourceAnalyzeServlet extends HttpServlet
{
	  /**
	 * 
	 */
...
//	private static final String CONTENT_TYPE = "text/html; charset=GBK";
	...
	public void service(HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException
	{
		      HttpSession session = request.getSession();
		       ...
		       String userIdCus =(String)session.getAttribute("userId");
			  // carrierName =(String)session.getAttribute("carrierName");
		       String userName = (String)session.getAttribute("userName");
		       String isPrint = (String)session.getAttribute("isPrint");
		       String isDetail = (String)session.getAttribute("isDetail");
			   //省去声明carrierIds对象
		       String customerIdsForm = (String)session.getAttribute("carrierIds");
		       ...
		       Map parameters = new HashMap();				
				//设置标题
				parameters.put("ReportTitle",  "时段区间统计");
				Collection coll = getResourceScopeAnalyzeColl(startDate,endDate,carrierIds,userIdCus,userName,isPrint,isDetail);
					...
					File reportFile = new File(context.getRealPath(reportsTemplePath +"resourceAnalyze_report.jasper"));
...
//					                     out.println("bytes were null!");  
	...
	public Collection getResourceScopeAnalyzeColl(String startDate, String endDate, String[] carrierIds, String userIdCus, String userName, String isPrint,String isDetail) {
		// TODO Auto-generated method stub
		Collection coll = new ArrayList();
		List ls = new ArrayList();
		OrderDayInfoManager mgr = (OrderDayInfoManager)getBean("orderDayInfoManager");
		if(isDetail.equals("1")){
			ls = mgr.getResourceListByDate(startDate,endDate,carrierIds,userIdCus,userName,isPrint,isDetail);
		}else{
			ls = mgr.getCarrierByDatePandect(startDate,endDate,carrierIds,userIdCus,userName,isPrint);
		}
