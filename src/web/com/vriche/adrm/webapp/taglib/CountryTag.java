...
public class CountryTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        if (scope != null) {
            ...
            if (prompt != null) {
//                sb.append("    <option value=\"\" class=\"select\"  selected=\"selected\">");
            ...
            for (Iterator i = countries.iterator(); i.hasNext();) {
                ...
                sb.append("    <option class=\"select\" value=\"" + country.getValue() + "\"");
...
//                LabelValue country = new LabelValue(name, iso);
                LabelValue country = new LabelValue(name, name);

                if (!countries.contains(country)) {
//                    countries.add(new LabelValue(name, iso));
                    countries.add(new LabelValue(name, name));
                }
            }
        }
