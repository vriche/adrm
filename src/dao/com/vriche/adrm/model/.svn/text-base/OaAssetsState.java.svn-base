 ...
 * 
 * <p><a href="OaAssetsState.java.html"><i>View Source</i></a></p>
 * 
 * @struts.form include-all="true"  extends="BaseForm"
 * @hibernate.class table="tb_oa_assets_state"
 * 
 */
public class OaAssetsState extends BaseObjectWithoutNestedFormValidation {
	

	private static final long serialVersionUID = 2639588231087879601L;
	...
	public OaAssetsState() {};

	/**
	 * @hibernate.id column="assets_state_id" generator-class="native"
	 *               unsaved-value="null"
	 */
	public Long getId() {
		return id;
