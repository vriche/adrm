 ...
 * @hibernate.class table="tb_oa_work_flow_check_state"
 * 
 */
public class OaWorkFlowCheckState extends BaseObjectWithoutNestedFormValidation {
	 ...
	 * @return Long
	 * 
	 * @hibernate.id column="check_state_id" generator-class="native" unsaved-value="null"
	 */
	public Long getId() {
		return id;
	}
