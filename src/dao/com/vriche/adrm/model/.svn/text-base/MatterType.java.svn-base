 ...
 * 
 * <p><a href="MatterType.java.html"><i>View Source</i></a></p>
 * 
 * @struts.form include-all="true"  extends="BaseForm"
 * @hibernate.class table="tb_adver_matter_type"
 * 
 */
public class MatterType extends BaseObjectWithoutNestedFormValidation {
	...
	protected Set matterIds = new HashSet();
	 ...
	 * @return Long
	 * 
	 * @hibernate.id column="matter_type_id" generator-class="native" unsaved-value="null"
	 */
	public Long getId() {
		return id;
	}
	...
	public boolean equals(Object object) {
		if (!(object instanceof OaInfoType)) {
			return false;
		}
		OaInfoType rhs = (OaInfoType) object;
	 ...
	 */
	public int hashCode() {
		return new HashCodeBuilder(-1339048171, -226709635).append(this.value)
	...
	public Set getMatterIds() {
		return matterIds;
	}


	public void setMatterIds(Set matterIds) {
