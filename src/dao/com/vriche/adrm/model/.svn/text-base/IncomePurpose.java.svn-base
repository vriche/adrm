 ...
 * 
 * <p><a href="IncomePurpose.java.html"><i>View Source</i></a></p>
 * 
 * @struts.form include-all="true"  extends="BaseForm"
 * @hibernate.class table="tb_income_purpose"
 * 
 */
public class IncomePurpose extends BaseObjectWithoutNestedFormValidation {
	private static final long serialVersionUID = 4063887635519625178L;
	protected Long id;
    ...
    private List fitterList = new ArrayList();
    
    
    
    
    public IncomePurpose(){};



    /**
     * @hibernate.id column="income_purpose_id" generator-class="native" unsaved-value="null"
     */
    public Long getId() {
        return id;
    }
    ...
    * @hibernate.property column="modify_date" update="false" insert="true" type="timestamp"
     ...
     * @return Integer
     * 
     * @hibernate.property length="2" column="value" not-null="false"
     */
    ...
    public boolean equals(Object object) {
        if (!(object instanceof IncomePurpose)) {
            return false;
        }
        IncomePurpose rhs = (IncomePurpose) object;
     ...
     */
    public int hashCode() {
        return new HashCodeBuilder(-1801539255, 1135859547).append(this.value).append(this.modifyBy)
    ...
    public String toString() {
        return new ToStringBuilder(this).append("name", this.name).append(
                ...
                "version", this.version).append("value", this.value).append(
	...
	public List getFitterList() {
		return fitterList;
	}



	public void setFitterList(List fitterList) {
