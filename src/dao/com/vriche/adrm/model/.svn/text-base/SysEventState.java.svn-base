 ...
 * @hibernate.class table="tb_sys_event_state"
 * 
 */
public class SysEventState extends BaseObjectWithoutNestedFormValidation {
	 ...
	 * @return Long
	 * 
	 * @hibernate.id column="enent_state_id" generator-class="native" unsaved-value="null"
	 */
	public Long getId() {
		return id;
	}
	 ...
	 */
	public int hashCode() {
		return new HashCodeBuilder(-1835815253, -1935622613).append(this.value).append(this.modifyBy)
	...
	public boolean equals(Object object) {
		if (!(object instanceof SysEventState)) {
			return false;
		}
		SysEventState rhs = (SysEventState) object;
