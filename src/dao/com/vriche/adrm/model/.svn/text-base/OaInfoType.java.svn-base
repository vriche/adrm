 ...
 * @hibernate.class table="tb_oa_info_type"
 * 
 */
public class OaInfoType extends BaseObjectWithoutNestedFormValidation {
	 ...
	 * @return Long
	 * 
	 * @hibernate.id column="info_type_id" generator-class="native" unsaved-value="null"
	 */
	public Long getId() {
		return id;
	}
