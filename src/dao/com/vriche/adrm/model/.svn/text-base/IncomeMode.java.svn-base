 ...
 * 
 * <p><a href="IncomeMode.java.html"><i>View Source</i></a></p>
 * 
 * @struts.form include-all="true"  extends="BaseForm"
 * @hibernate.class table="tb_income_mode"
 * 
 */
public class IncomeMode extends BaseObjectWithoutNestedFormValidation {
	private static final long serialVersionUID = -8552289468431204841L;
	protected Long id;
    ...
    /**
     * @hibernate.id column="income_mode_id" generator-class="native" unsaved-value="null"
     */
    public Long getId() {
        return id;
    }
    ...
    * @hibernate.property column="modify_date" update="false" insert="true" type="timestamp"
    ...
    public boolean equals(Object object) {
        if (!(object instanceof IncomeMode)) {
            return false;
        }
        IncomeMode rhs = (IncomeMode) object;
     ...
     */
    public int hashCode() {
        return new HashCodeBuilder(1935444311, 2056182161).append(this.value).append(this.modifyBy)
