 ...
 * @hibernate.class table="tb_sys_prompt_mode"
 * 
 */
public class SysPromptMode extends BaseObjectWithoutNestedFormValidation {
	 ...
	 * @return Long
	 * 
	 * @hibernate.id column="prompt_mode_id" generator-class="native" unsaved-value="null"
	 */
	public Long getId() {
		return id;
	}
	...
	public boolean equals(Object object) {
		if (!(object instanceof SysPromptMode)) {
			return false;
		}
		SysPromptMode rhs = (SysPromptMode) object;
	 ...
	 */
	public int hashCode() {
		return new HashCodeBuilder(-1550440931, 243393519).append(this.value)
