 ...
 * 
 * <p><a href="SysUserType.java.html"><i>View Source</i></a></p>
 * 
 * @struts.form include-all="true"  extends="BaseForm"
 * @hibernate.class table="tb_sys_user_type"
 * 
 */
public class SysUserType extends BaseObjectWithoutNestedFormValidation {
	...
	/**
	 * @hibernate.id column="sys_user_type_id" generator-class="native"
	 *               unsaved-value="null"
	 */
	public Long getId() {
		return id;
	...
	public boolean equals(Object object) {
		if (!(object instanceof SysUserType)) {
			return false;
		}
		SysUserType rhs = (SysUserType) object;
	 ...
	 */
	public int hashCode() {
		return new HashCodeBuilder(721661715, -261963235).append(this.value)
