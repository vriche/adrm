...
/**
 * OaDocumentCatalogPermitType class
 * 
 * This class is used to 
 * 
 * <p><a href="OaDocumentCatalogPermitType.java.html"><i>View Source</i></a></p>
 * 
 * @struts.form include-all="true"  extends="BaseForm"
 * @hibernate.class table="tb_oa_document_catalog_permit_type"
 * 
 */
public class OaDocumentCatalogPermitType extends
		BaseObjectWithoutNestedFormValidation {

	private static final long serialVersionUID = 7556100707315877050L;
	protected Long id;
	...
	public OaDocumentCatalogPermitType() {};

	/**
	 * @hibernate.id column="permit_type_id" generator-class="native"
	 *               unsaved-value="null"
	 */
	public Long getId() {
		return id;
