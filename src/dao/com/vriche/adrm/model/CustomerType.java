 ...
 * 
 * <p><a href="CustomerType.java.html"><i>View Source</i></a></p>
 * 
 * @struts.form include-all="true"  extends="BaseForm"
 * @hibernate.class table="tb_customer_type"
 * 
 */

public class CustomerType extends BaseObjectWithoutNestedFormValidation {
    ...
    /**
     * @hibernate.id column="customer_type_id" generator-class="native" unsaved-value="null"
     */
    public Long getId() {
        return id;
    }
    ...
    * @hibernate.property column="modify_date" update="false" insert="true" type="timestamp"
     ...
     * @return String
     * 
     * @hibernate.property length="128" column="code" not-null="false"
     */
    ...
    public boolean equals(Object object) {
        ...
        CustomerType rhs = (CustomerType) object;
     ...
     */
    public int hashCode() {
        return new HashCodeBuilder(1749767077, 386862379).append(this.code)
                .append(this.memo).append(this.modifyBy)
