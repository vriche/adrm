 ...
 * 
 * <p><a href="ResourceType.java.html"><i>View Source</i></a></p>
 * 
 * @struts.form include-all="true"  extends="BaseForm"
 * @hibernate.class table="tb_ad_resource_type"
 * 
 */
public class ResourceType extends BaseObject {
    /**
	 * 
	 */
	...
	/**
     * @hibernate.id column="ad_ad_resource_type_id" generator-class="native" unsaved-value="null"
     */
    public Long getId() {
        return id;
    }
    ...
    * @hibernate.property column="modify_date" update="false" insert="true" type="timestamp"
     ...
     */
    public int hashCode() {
        return new HashCodeBuilder(1062310227, -1391788969).append(this.memo)
