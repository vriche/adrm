...
/**
 * ImportProgramListRequestType.java
 *
 ...
 */
            ...
            /**
            *  ImportProgramListRequestType bean class
            */
        
        public  class ImportProgramListRequestType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = ImportProgramListRequestType
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for BroadcastListEntity
                        */

                        
                                    protected mreml2.schema.programlist.BroadcastListEntityType localBroadcastListEntity ;
                                

                           /**
                           * Auto generated getter method
                           * @return mreml2.schema.programlist.BroadcastListEntityType
                           */
                           public  mreml2.schema.programlist.BroadcastListEntityType getBroadcastListEntity(){
                               return localBroadcastListEntity;
                           }
                            ...
                            /**
                               ...
                               * @param param BroadcastListEntity
                               */
                               public void setBroadcastListEntity(mreml2.schema.programlist.BroadcastListEntityType param){
                            
                                            this.localBroadcastListEntity=param;
                        ...
                        */
                                    ...
                                    protected mreml2.schema.commondatatype.CommonRequestType localCommonRequest ;
                                

                           /**
                           * Auto generated getter method
                           * @return mreml2.schema.commondatatype.CommonRequestType
                           */
                           public  mreml2.schema.commondatatype.CommonRequestType getCommonRequest(){
                            ...
                            /**
                               ...
                               */
                               public void setCommonRequest(mreml2.schema.commondatatype.CommonRequestType param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       ImportProgramListRequestType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ImportProgramListRequestType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ImportProgramListRequestType",
                           xmlWriter);
                   }
                                            ...
                                            if (localBroadcastListEntity==null){
                                                 throw new org.apache.axis2.databinding.ADBException("BroadcastListEntity cannot be null!!");
                                            }
                                           localBroadcastListEntity.serialize(new javax.xml.namespace.QName("http://MREML2/schema/ProgramList","BroadcastListEntity"),
                                               factory,xmlWriter);
                                        
                                            if (localCommonRequest==null){
                                                 throw new org.apache.axis2.databinding.ADBException("CommonRequest cannot be null!!");
                                            }
                                           localCommonRequest.serialize(new javax.xml.namespace.QName("http://MREML2/schema/CommonDataType","CommonRequest"),
                                               factory,xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://MREML2/schema/ProgramList",
                                    ...
                                    elementList.add(localBroadcastListEntity);
    ...
    public static class Factory{
        ...
        */
        public static ImportProgramListRequestType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ImportProgramListRequestType object =
                new ImportProgramListRequestType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ImportProgramListRequestType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ImportProgramListRequestType)mreml2.schema.programlistparameter.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list4 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://MREML2/schema/ProgramList","BroadcastListEntity").equals(reader.getName())){
                                
                                                object.setBroadcastListEntity(mreml2.schema.programlist.BroadcastListEntityType.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://MREML2/schema/CommonDataType","CommonRequest").equals(reader.getName())){
                                
                                                object.setCommonRequest(mreml2.schema.commondatatype.CommonRequestType.Factory.parse(reader));
