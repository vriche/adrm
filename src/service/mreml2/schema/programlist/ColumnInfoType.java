 ...
 */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                           ...
                           */
                           public  int getColumnType(){
                            ...
                            /**
                               ...
                               */
                               public void setColumnType(int param){
                            
                                       // setting primitive attribute tracker to true
                                       
                                               if (param==java.lang.Integer.MIN_VALUE) {
                                           localColumnTypeTracker = false;
                                              
                                       } else {
                                          localColumnTypeTracker = true;
                                       }
                        ...
                        /**
                        * field for ColumnDuration
                        */

                        
                                    protected long localColumnDuration ;
                           ...
                           * @return long
                           */
                           public  long getColumnDuration(){
                               return localColumnDuration;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param ColumnDuration
                               */
                               public void setColumnDuration(long param){
                            
                                            this.localColumnDuration=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       ColumnInfoType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ColumnInfoType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ColumnInfoType",
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"ColumnType", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"ColumnType");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("ColumnType");
                                    }
                                
                                               if (localColumnType==java.lang.Integer.MIN_VALUE) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("ColumnType cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localColumnType));
                                               }
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"ColumnDuration", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"ColumnDuration");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("ColumnDuration");
                                    }
                                
                                               if (localColumnDuration==java.lang.Long.MIN_VALUE) {
                                           
                                                         writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localColumnDuration));
                                               }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localColumnType));
                            }
                                      elementList.add(new javax.xml.namespace.QName("http://MREML2/schema/ProgramList",
                                                                      "ColumnDuration"));
                                 
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localColumnDuration));
                             if (localExtraElementTracker){
                            if (localExtraElement != null) {
                                for (int i = 0;i < localExtraElement.length;i++){
                                    if (localExtraElement[i] != null){
    ...
    public static class Factory{
        ...
        */
        public static ColumnInfoType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ColumnInfoType object =
                new ColumnInfoType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ColumnInfoType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ColumnInfoType)mreml2.schema.programlistparameter.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list5 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://MREML2/schema/ProgramList","ColumnCode").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://MREML2/schema/ProgramList","ColumnName").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://MREML2/schema/ProgramList","ColumnType").equals(reader.getName())){
                                    ...
                                    java.lang.String content = reader.getElementText();
                                        ...
                                        reader.next();
                                               ...
                                               object.setColumnType(java.lang.Integer.MIN_VALUE);
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://MREML2/schema/ProgramList","ColumnDuration").equals(reader.getName())){
                                    ...
                                    java.lang.String content = reader.getElementText();
                                              ...
                                              object.setColumnDuration(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToLong(content));
                                            
                                       } else {
                                           
                                           
                                                   object.setColumnDuration(java.lang.Long.MIN_VALUE);
