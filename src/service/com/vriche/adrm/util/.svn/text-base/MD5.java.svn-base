...
//            System.out.println("MD5(\"abcdefghijklmnopqrstuvwxyz\"):".concat(String.valueOf(String.valueOf(m.getMD5ofStr("abcdefghijklmnopqrstuvwxyz")))));
//            System.out.println("MD5(\"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789\"):".concat(String.valueOf(String.valueOf(m.getMD5ofStr("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789")))));
        } else
        {
//            System.out.println(String.valueOf(String.valueOf((new StringBuffer("MD5(")).append(args[0]).append(")=").append(m.getMD5ofStr(args[0])))));
        }
    }
