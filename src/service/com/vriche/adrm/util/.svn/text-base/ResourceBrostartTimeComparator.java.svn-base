...
public class ResourceBrostartTimeComparator implements Comparator {
	...
	public int compare(Object a, Object b) {
		...
		Resource right = (Resource) b;
		 ...
		 Integer l= left.getWorkspan().getBroadcastStartTime();
		 Integer r = right.getWorkspan().getBroadcastStartTime();
