 ...
 * 																			*
 ***************************************************************************/
package com.vriche.adrm.service.security.acegi.intercept.web;
...
//	private final Log logger = LogFactory.getLog(getClass());
	...
	public ConfigAttributeDefinition lookupAttributes(String url) {
		...
		List urls = acegiCacheManager.getResourcesByType(Resource.RESOURCE_TYPE_URL);
		...
		for (Iterator iterator = urls.iterator(); iterator.hasNext();) {
			...
			if(isConvertUrlToLowercaseBeforeComparison()) resString = resString.toLowerCase();
