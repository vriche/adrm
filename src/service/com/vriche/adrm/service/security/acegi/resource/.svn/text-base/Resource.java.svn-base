package com.vriche.adrm.service.security.acegi.resource;
...
/**
 * ResourceDetails的实现类
 * resString 资源串， 如Url资源�? /admin/index.jsp, Method资源�? com.abc.service.userManager.save �?
 * resType 资源类型，如URL, METHOD �?
 * authorities 该资源所拥有的权�?
 * @author cac
 */
