...
/**
 * QueryBroadcastListRequestType.java
 *
 ...
 */
            ...
            /**
            *  QueryBroadcastListRequestType bean class
            */
        
        public  class QueryBroadcastListRequestType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = QueryBroadcastListRequestType
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected java.lang.String localPlayDate ;
                           ...
                           */
                           public  java.lang.String getPlayDate(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param PlayDate
                               */
                               public void setPlayDate(java.lang.String param){
                            
                                            this.localPlayDate=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       QueryBroadcastListRequestType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":QueryBroadcastListRequestType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"ChannelCode", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"ChannelCode");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("ChannelCode");
                                    }
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"PlayDate", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"PlayDate");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("PlayDate");
                                    }
                                

                                          if (localPlayDate==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("PlayDate cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localPlayDate);
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://dayang.com/ADP/schema/ADPServiceParameterType/0.1",
                                    ...
                                    elementList.add(localCommonRequest);
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://dayang.com/ADP/schema/ADPServiceParameterType/0.1",
                                        ...
                                        if (localPlayDate != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPlayDate));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("PlayDate cannot be null!!");
                                        }
                                     if (localExtendAttributesTracker){
    ...
    public static class Factory{
        ...
        */
        public static QueryBroadcastListRequestType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            QueryBroadcastListRequestType object =
                new QueryBroadcastListRequestType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"QueryBroadcastListRequestType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (QueryBroadcastListRequestType)com.dayang.adp.schema.adfileinfoentity._1_0.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dayang.com/ADP/schema/ADPServiceParameterType/0.1","ChannelCode").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dayang.com/ADP/schema/ADPServiceParameterType/0.1","PlayDate").equals(reader.getName())){
