...
/**
 * ImportMaterialRequestType.java
 *
 ...
 */
            ...
            /**
            *  ImportMaterialRequestType bean class
            */
        
        public  class ImportMaterialRequestType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = ImportMaterialRequestType
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for ImportOption
                        */

                        
                                    protected int localImportOption ;
                           ...
                           */
                           public  int getImportOption(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param ImportOption
                               */
                               public void setImportOption(int param){
                            
                                            this.localImportOption=param;
                        ...
                        /**
                        * field for ADMaterialEntity
                        */

                        
                                    protected com.dayang.adp.schema.admaterialentity._1_0.ADMaterialEntityType localADMaterialEntity ;
                                

                           /**
                           * Auto generated getter method
                           * @return com.dayang.adp.schema.admaterialentity._1_0.ADMaterialEntityType
                           */
                           public  com.dayang.adp.schema.admaterialentity._1_0.ADMaterialEntityType getADMaterialEntity(){
                               return localADMaterialEntity;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param ADMaterialEntity
                               */
                               public void setADMaterialEntity(com.dayang.adp.schema.admaterialentity._1_0.ADMaterialEntityType param){
                            
                                            this.localADMaterialEntity=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       ImportMaterialRequestType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ImportMaterialRequestType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"ImportOption", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"ImportOption");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("ImportOption");
                                    }
                                
                                               if (localImportOption==java.lang.Integer.MIN_VALUE) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("ImportOption cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localImportOption));
                                               }
                                    
                                   xmlWriter.writeEndElement();
                             
                                            if (localADMaterialEntity==null){
                                                 throw new org.apache.axis2.databinding.ADBException("ADMaterialEntity cannot be null!!");
                                            }
                                           localADMaterialEntity.serialize(new javax.xml.namespace.QName("http://dayang.com/ADP/schema/ADMaterialEntity/1.0","ADMaterialEntity"),
                                               factory,xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://dayang.com/ADP/schema/ADPServiceParameterType/0.1",
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localImportOption));
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://dayang.com/ADP/schema/ADMaterialEntity/1.0",
                                    ...
                                    elementList.add(localADMaterialEntity);
                                 if (localExtendAttributesTracker){
                            elementList.add(new javax.xml.namespace.QName("http://dayang.com/ADP/schema/ADPServiceParameterType/0.1",
                                                                      "ExtendAttributes"));
    ...
    public static class Factory{
        ...
        */
        public static ImportMaterialRequestType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ImportMaterialRequestType object =
                new ImportMaterialRequestType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ImportMaterialRequestType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ImportMaterialRequestType)com.dayang.adp.schema.adfileinfoentity._1_0.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dayang.com/ADP/schema/ADPServiceParameterType/0.1","ImportOption").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setImportOption(
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dayang.com/ADP/schema/ADMaterialEntity/1.0","ADMaterialEntity").equals(reader.getName())){
                                
                                                object.setADMaterialEntity(com.dayang.adp.schema.admaterialentity._1_0.ADMaterialEntityType.Factory.parse(reader));
