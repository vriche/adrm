            ...
            <td valign="bottom"><table border="0" cellpadding="0" cellspacing="1" width="100%">
                <tbody>
                  <tr> 
                     ...
                     <td width="1px"> <input  type="text" value="±àÅÅ"  width="30px" class="myLable2" style="cursor: pointer;" id="Lable_radiobutton1"></td> 
                     <td width="1px"> <input style="cursor: pointer;" name="radiobutton" id="radiobutton2" type="radio" value="radiobutton"></td>     
                     <td width="1px"><input  type="text" value="µæÆ¬"  width="30px" class="myLable2" style="cursor: pointer;" id="Lable_radiobutton2"></td> 
                     ...
                     <td width="1px" id="buttonTable">   
                         ...
                         <tr>
		                     ...
		                     <td width="1px"> <input class="button" name="Btn_build_bro" id="Btn_build_bro" type="button" value='½¨Á¢'></td>   
		                     <adrm_order:authorizeTag res="tag_publish_arrange">  
		 					 <td width="1px"> <input class="button" name="Btn_save_bro" id="Btn_save_bro" type="button" value='±£´æ'></td>   
		                     </adrm_order:authorizeTag>  
		                     
		                     <!-- td width="1px"> <input class="button" name="Btn_preView_bro" id="Btn_preView_bro" type="button" value='Ô¤ÀÀ'></td>   
		                     <td width="1px"> <input class="button" name="Btn_print_bro" id="Btn_print_bro" type="button" value='´òÓ¡'></td>   
		                     <td width="1px"> <input class="button" name="Btn_export_bro" id="Btn_export_bro" type="button" value='µ¼³ö'></td -->   
		                      ...
		                      <td width="1px">
		                       ...
		                       <td width="1px"> <input  name="Btn_load_history" id="Btn_load_history" type="hidden" onclick="getDate('bro_date_history')" value='Btn_load_history'></td>  
		                        ...
		                        <!-- td width="1px"> <input  class="button" name="displayTree" id="displayTree" type="hidden" value="Òþ²Ø"></td -->   
                        ...
                        <td width="1px"> <input class="button" name="Btn_removeRow" id="Btn_removeRow" type="button" value='É¾³ý'></td>   
                       ...
                       <td width="1px" ><div id="printReportDiv" name="printReportDiv"/></td>  
                        ...
                        <td width="1px"> <input class="button" name="Btn_reference" id="Btn_reference" type="button" value='²Î¿¼±àÅÅ'></td>   
                      <td>&nbsp;</td>  
