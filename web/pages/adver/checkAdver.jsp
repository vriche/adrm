...
<script type="text/javascript" src="<c:url value='/scripts/adver/checkAdverService.js'/>"></script>
...
<table border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td  valign="top"> <div id="gridbox" width="500px" height="300px" style="background-color:white;"/></td>
  </tr>
</table>
</body>
