...
<html:hidden property="version"/>
    ...
    <li>
        <adrm_order:label styleClass="desc" key="publishArrangeForm.publishArrangeDetails"/>
        <html:errors property="publishArrangeDetails"/>
        <html:text property="publishArrangeDetails" styleId="publishArrangeDetails" styleClass="text medium"/>
