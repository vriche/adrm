...
<ul>
    ...
    <li>
        <adrm_order:label styleClass="desc" key="matterTypeForm.createBy"/>
    ...
    <li>
        <adrm_order:label styleClass="desc" key="matterTypeForm.createDate"/>
...
<html:hidden property="id"/>
    ...
    <li>
        <adrm_order:label styleClass="desc" key="matterTypeForm.modifyBy"/>
    ...
    <li>
        <adrm_order:label styleClass="desc" key="matterTypeForm.modifyDate"/>
    ...
    <li>
        <adrm_order:label styleClass="desc" key="matterTypeForm.name"/>
    ...
    <li>
        <adrm_order:label styleClass="desc" key="matterTypeForm.value"/>
