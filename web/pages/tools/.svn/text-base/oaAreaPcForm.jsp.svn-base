	...
	<tbody>
		...
		<tr>
			<td width="50%" nowrap="nowrap" class="dataLabel">
				<!--城市名称--!>
				<adrm_order:label styleClass="" key="oaAreaPcForm.name"/>:
		    </td>
		    <td>
		...
		<tr> 
			<td width="50%" nowrap="nowrap" class="dataLabel">
				<fmt:message key="oaAreaPcForm.areaCityId"/>:       	
			</td>
			<td>
		        <html:errors property="areaCityId"/>
		        <html:text property="areaCityId" styleId="areaCityId"/>
			</td>
		</tr>
		
		<tr> 
			<td width="50%" nowrap="nowrap" class="dataLabel">
				<fmt:message key="oaAreaPcForm.ldCode"/>:       	
			</td>
			<td>
		        <html:errors property="ldCode"/>
		        <html:text property="ldCode" styleId="ldCode"/>
			</td>
		</tr>
		...
		<tr>
			<td width="50%" nowrap="nowrap" class="dataLabel">
				<!--邮政编码--!>
			    <adrm_order:label styleClass="" key="oaAreaPcForm.postCode"/>:
		    </td>
		    <td>
				<div style="position:relative;">
					<span style="margin-left:100px;width:18px;overflow:hidden;">
					  	<adrm_order:selectList name="areaPcs" key="28"  toScope="page"/> 
					     <html:select property="postCode" styleId="areaPcId"  style="width:140px;margin-left:-100px"> 
		  ...
		  <tr>
		  	<td>
		  		<div align="center"> 
			        ...
			        <html:submit styleClass="" property="method.delete" onclick="bCancel=true; return confirmDelete('OaAreaPc')">
