...
<ul>
    ...
    <li>
        <adrm_order:label styleClass="desc" key="oaScratchpadForm.createBy"/>
    ...
    <li>
        <adrm_order:label styleClass="desc" key="oaScratchpadForm.createDate"/>
...
<html:hidden property="id"/>
    ...
    <li>
        <adrm_order:label styleClass="desc" key="oaScratchpadForm.modifyBy"/>
    ...
    <li>
        <adrm_order:label styleClass="desc" key="oaScratchpadForm.modifyDate"/>
    ...
    <li>
        <adrm_order:label styleClass="desc" key="oaScratchpadForm.content"/>
...
<html:hidden property="version"/>
    ...
    <li class="buttonBar bottom">
        ...
        <html:submit styleClass="button" property="method.delete" onclick="bCancel=true; return confirmDelete('OaScratchpad')">
