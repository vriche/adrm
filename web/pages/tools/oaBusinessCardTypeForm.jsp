	...
	<tbody>
		...
		<tr> 
			<td nowrap="nowrap" class="requiredInput">
				<fmt:message key="oaBusinessCardTypeForm.name"/>:       	
			</td>
			<td>
		...
		<tr> 
			<td width="50%" nowrap="nowrap" class="dataLabel">
				<fmt:message key="oaBusinessCardTypeForm.value"/>:       	
			</td>
			<td>
		  ...
		  <tr>
		  	<td>
		  		<div align="center"> 
			        ...
			        <html:submit styleClass="" property="method.delete" onclick="bCancel=true; return confirmDelete('OaBusinessCardType')">
