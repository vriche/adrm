...
<title><fmt:message key="carrierBasalAnalyze.title"/></title>
<content tag="heading"><fmt:message key="carrierBasalAnalyze.heading"/></content>
...
<script type="text/javascript" src="<c:url value='/scripts/analyze/carrierBasalAnalyzeService.js'/>"></script>
            ...
            <td valign="bottom"><table border="0" cellpadding="0" cellspacing="1" width="100%">
                <tbody>
                  <tr> 
                   ...
                   <td width="1%" id="orgId_td"> <select id="orgId"></select></td>
	                 ...
	                 <td width="1%"><input type="text" value="频道"  width="120px" class="myLable2"></td>

	                 <td  width="1%"><input name="carrierName" id="carrierName" size="12px" type="text" autocomplete=off/></td>
