...
<script type="text/javascript" src="<c:url value='/scripts/analyze/customerProductChartService.js'/>"></script>



<content tag="heading"><fmt:message key="customerProductRelIncome.title"/></content>
