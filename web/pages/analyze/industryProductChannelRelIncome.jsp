...
<title><fmt:message key="industryProductChannelRelIncome.title"/></title>
<content tag="heading"><fmt:message key="industryProductChannelRelIncome.heading"/></content>
...
<script type="text/javascript" src="<c:url value='/scripts/analyze/industryTypeProductChannelService.js'/>"></script>
            ...
            <td valign="bottom"><table border="0" cellpadding="0" cellspacing="1" width="100%">
                <tbody>
                  <tr> 
											 		...
											 		<td width="0px"><input type="text" value="开始"  width="120px" class="myLable2"/></td>
												 <td width="0px"><input type ="text" id ="beginDate" name="beginDate" size=10></td>
							 					 <td width="0px"><input  type="text" value="结束"  size="6" class="myLable2"/></td>
												 <td width="0px"><input type ="text" id ="overDate" name="overDate" size=10></td>  
													<td width="0px"><select name="userOwner" id="userOwner" /></td>
													<td width="0px"><select name="select" id="carrierName"/></td>
													<td width="0px"><input type="button"   class="button" id="Btn_view_order" value='预览'>	</td> 
													<td width="0px"><input type="button"   class="button" id="Btn_print_order" value='打印'>	</td> 
													<td width="0px"><input type="button"   class="button" id="Btn_export_order" value='导出'>	</td>                     
	                  <td width="0px"><input type="button"   class="button" id="searchTotalBrowser" value='<fmt:message key="orderDayInfoForm.button.search"/>'>	</td>   
                    <td width="0px"><input type="button"   class="button" id="displayChar" value='<fmt:message key="orderDayInfoForm.button.displayChar"/>'>	</td> 
                    <td width="0px">&nbsp;</td>
