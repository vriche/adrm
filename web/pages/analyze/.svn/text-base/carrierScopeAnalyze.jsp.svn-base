...
<title><fmt:message key="carrierScopeAnalyze.title"/></title>
...
<script type="text/javascript" src="<c:url value='/scripts/analyze/carrierScopeAnalyzeService.js'/>"></script>
                  ...
                  <tr> 
                    ...
                    <td width="1px" id="orgId_td"> <select id="orgId"/></td>
					 ...
					 <td width="1px"><input type ="text" id ="beginDate" name="beginDate" size=10></td>
 					 ...
 					 <td width="1px"><input  type="text" value="结束"  width="120px" class="myLable2"></td>
 					 
					 <td width="1px"><input type ="text" id ="overDate" name="overDate" size=10></td>                  	

	                 <td width="1px" style="display:none"> <select name="userOwner" id="userOwner" /> </td>

	                 <td width="1px"><div id="orderCategoryIdDiv"></td>
