...
<title><fmt:message key="resourceAdverAnalyze.title"/></title>
...
<script type="text/javascript" src="<c:url value='/scripts/analyze/resourceAdverAnalyze.js'/>"></script>

<content tag="heading"><fmt:message key="resourceAdverAnalyze.title"/></content>
        ...
        <tbody>
          <tr> 
            <td width="50"><img src="images/table1/textbox_top_left.gif" height="27" width="50"></td>
	                 ...
	                 <td width="1%" > <div id="theDivCustomerName"/> </td>
