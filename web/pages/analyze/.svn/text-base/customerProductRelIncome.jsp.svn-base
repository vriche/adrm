...
<title><fmt:message key="customerProductRelIncome.title"/></title>
<content tag="heading"><fmt:message key="customerProductRelIncome.heading"/></content>
...
<script type="text/javascript" src="<c:url value='/scripts/analyze/customerProductService.js'/>"></script>
                  ...
                  <tr> 
                    ...
                    <td width="1%" id="orgId_td"> <select id="orgId"/></td>
                     <td width="1px"><select id="resource_year"  style="CURSOR: pointer;" /></td>
 					 ...
 					 <td width="1px"><input type="text" value="开始"  width="120px" class="myLable2"/></td>
					 ...
					 <td width="1px"><input type ="text" id ="overDate" name="overDate" size=10></td>  
					 	 ...
					 	 <td width="1px"><input type="text" value="业务员"  width="150px" class="myLable2"/></td>  
					 	 <td width="1px"><input name="userOwner1" id="userOwner1" size="12px" type="text" autocomplete=off/></td>      
					 
				
                   	 <!-- td width="1%"><div id="userRenderDiv" /></td -->
