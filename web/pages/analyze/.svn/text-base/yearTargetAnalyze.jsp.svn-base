...
<script type="text/javascript" src="<c:url value='/scripts/analyze/yearTargetAnalyzeService.js'/>"></script>	        
 
<content tag="heading"><fmt:message key="yearTargetAnalyze.title"/></content> 
               			 ...
               			 <table width="100%">
			                 ...
			                 <td width="1%">	
	                 				<select id="query" style="CURSOR: pointer;" >
										...
										<option value="3"><fmt:message key="orderDayInfoForm.button.financeTarget"/></option>
										<option value="4"><fmt:message key="orderDayInfoForm.datelength"/></option>
									</select>
							</td> 
