...
<script type="text/javascript" src="<c:url value='/scripts/analyze/carrierBasalChartService.js'/>"></script>



<content tag="heading"><fmt:message key="carrierBasalAnalyze.title"/></content>
