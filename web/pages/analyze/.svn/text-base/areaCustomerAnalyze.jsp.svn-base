...
<script type="text/javascript" src="<c:url value='/scripts/analyze/areaCustomerAnalyzeService.js'/>"></script>
      ...
      <tr>
	    ...
	    <td valign="top">
			...
			<div id="adResCount" >
				...
				<div id="gridbox"  height="100%"  width="100%"  style="background-color:white;"/>		
			</div>	
...
<form name="ReportForm" id="ReportForm" method="post">
	...
	<input type="hidden" name="channelModelForm" id="channelModelForm" value="0">
