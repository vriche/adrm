...
<script type="text/javascript" src="<c:url value='/scripts/analyze/orderDetailAnalyzeService.js'/>"></script>
                ...
                <tbody>
                  <tr> 
                    ...
                    <td width="1%">
						...
						<div id="theDivSearch" style="position:absolute;  OVERFLOW: auto;left:0px;top:21px;width:550px;height:400px;visibility:hidden;border:solid green 2px;background-color:white;z-index:1">	
			                ...
			                <select name="userOwner" id="userOwner"/>
							 ...
							 <tr>
								...
								<tr>
								<td align="left" colspan="4"><label for="isNotReturnValue" style="cursor: pointer;"><fmt:message key="incomePurposeDetail.notReturnValue"/></label><input id="isNotReturnValue" name="isNotReturnValue" type='checkbox' value=0/></TD>
								</tr>
					  ...
					  <td width="1%"><input type="button"   class="button" id="displayChar" value='图表'>	</td>   
