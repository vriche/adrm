...
<%
	...
	String filename = jFreeChart.carrierScopeAnalyzeInCount(sysUser,startDate,endDate,carrierIds,userId1,session, new PrintWriter(out));
	String graphURL = request.getContextPath() + "/servlet/DisplayChart?filename=" + filename;

	String filename1 = jFreeChart.carrierScopeAnalyzeTimeSum(sysUser,startDate,endDate,carrierIds,userId1,session, new PrintWriter(out));
