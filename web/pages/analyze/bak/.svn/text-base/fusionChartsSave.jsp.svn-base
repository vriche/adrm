...
<%@ page import="javax.imageio.ImageIO"%><meta http-equiv="Content-Type" content="text/html; charset=gb2312">
<%
	...
	try{
		...
		out.clear();
out = pageContext.pushBody();OutputStream os = response.getOutputStream();
		ImageIO.write(chart, "jpeg", os);os.flush();
		os.close();
