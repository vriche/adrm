...
<title><fmt:message key="customerOrderCategory.title"/></title>
...
<script type="text/javascript" src="<c:url value='/scripts/analyze/orderCategoryCustomerChartService.js'/>"></script>



<content tag="heading"><fmt:message key="customerOrderCategory.title"/></content>
        ...
        <tbody>
          <tr> 
			...
			<div id="chartdiv" align="center" border-style="none" >
 			...
 			<div id="chartdiv2" align="center" style="display:none" >
