...
<content tag="heading"><fmt:message key="customerOrderCategory.heading"/></content>
...
<script type="text/javascript" src="<c:url value='/scripts/analyze/orderCategoryCustomerService.js'/>"></script>
