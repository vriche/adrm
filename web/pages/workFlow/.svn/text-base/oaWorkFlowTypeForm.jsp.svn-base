	...
	<tbody>
  		...
  		<tr> 
		    <td width="50%" nowrap="nowrap" class="dataLabel">
		    	<adrm_order:label styleClass="" key="oaWorkFlowTypeForm.name"/>	
	        </td>
	    ...
	    <tr> 
		    <td width="50%" nowrap="nowrap" class="dataLabel">
		    	<fmt:message key="oaWorkFlowTypeForm.displayNo"/>:       	
	        </td>
	        <td>
	 ...
	 <tr>
		<td>
			<div align="center"
		        ...
		        <html:submit styleClass="" property="method.delete" onclick="bCancel=true; return confirmDelete('OaWorkFlowType')">
