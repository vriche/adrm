          ...
          <tr> 
            <td ><table  id="mytb" class=ListShort width="100%" cellpadding="0"  onmouseover="javascript:Table_mouseover()" onmouseout="javascript:Table_mouseout()"  >
                  ...
                  <tr class=Header> 
                    ...
                    <th>
                      <!-- 播出时间 --><fmt:message key="workspanForm.broadcastEndTime"/></th>
                    <th>
                      <!-- 星期一 --><fmt:message key="workspanForm.monLength"/></th>
                    <th>
                      <!-- 星期二 --><fmt:message key="workspanForm.tueLength"/></th>
                    <th>
                      <!-- 星期三 --><fmt:message key="workspanForm.thiLength"/></th>
                    <th>
                      <!-- 星期四 --><fmt:message key="workspanForm.wenLength"/></th>
                    <th>
        ...
        <tr> 
          <td width="30%" valign="top"> <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" id="ep">
              <tbody>
                <tr> 
                  <td nowrap="nowrap" class="dataLabel">
                  <!-- 类别 --><fmt:message key="carrierForm.enable"/>: </td>
                  <td >
