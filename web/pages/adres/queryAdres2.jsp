                ...
                <tbody>
                  ...
                  <td width="1px" id="orgId_td"> <select id="orgId"/></td>
                     ...
                     <td>&nbsp;</td>		
	   				 ...
	   				 <td class="red"   align="middle" width="1px"><input  type="text" value="≥¨ ±"  width="30px" class="myLable2"></td><!--≥¨ ±-->
					 <td class="green" align="middle" width="1px"><input  type="text" value=" £”‡"  width="30px" class="myLable3"></td><!-- £”‡-->
