	...
	<tbody>
		<tr> 
		    <td nowrap="nowrap" class="requiredInput">
		    	<fmt:message key="resourceTypeForm.name"/>:       	
	        </td>
	        <td>
		...
		<tr> 
		    <td width="50%" nowrap="nowrap" class="dataLabel">
		    	<fmt:message key="resourceTypeForm.enable"/>:       	
	        </td>
	        <td>
		...
		<tr> 
		    <td width="50%" nowrap="nowrap" class="dataLabel">
		    	<fmt:message key="resourceTypeForm.memo"/>:       	
	        </td>
	        <td>
	      ...
	      <!-- tr> 
		    ...
		    <td nowrap="nowrap" class="dataLabel">
		    	<adrm_order:label key="yearAnalyze.year"/>:
		    ...
		    <td>
				<span style="margin-left:100px;width:18px;overflow:hidden;">
				  	<adrm_order:selectList name="yearsversion" key="43"  toScope="page"/> 
				     	<html:select property="version" styleId="version"  style="width:160px;margin-left:-100px"> 
				     	<html:options collection="yearsversion"  property="value" labelProperty="label"/> 
				     </html:select> 								
				</span>
			</td>		
		  ...
		  <tr>
		  	<td>
		  		<div align="center"> 
			        ...
			        <html:submit styleClass="" property="method.delete" onclick="bCancel=true; return confirmDelete('ResourceType')">
