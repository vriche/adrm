...
<script type="text/javascript" src="<c:url value='/scripts/admin/carrierTypeService.js'/>"></script>	
...
<form action="carrierTypes.html"  method="get" id="carrierTypeForm" name="carrierTypeForm">
                ...
                <tbody>
                  <tr> 
                    <td>
                        ...
                        <td width="1%" id="orgId_td"><select id="orgId" name="orgId"/> 
