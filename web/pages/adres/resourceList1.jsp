...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="15%" valign="top"><table width="100%" border="1" cellspacing="0" cellpadding="0" id="leftTreeBoxTable">
        <tr> 
                ...
                <td> 
                  ...
                  <div align="center"> 
                    <table width="96%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td ><input name="radiobutton" type="radio" onClick="window.location.href='javascript:void 0'" value="radiobutton" checked>
                          <!-- 基本位置 --> 
						  <fmt:message key="resourceForm.title.basePos"/>
						  </td>
                        <td><input name="radiobutton" type="radio" value="radiobutton" onClick="window.location.href='compages.html'">
                          <!-- 套播组合 -->
                ...
                <td width="20%">
	                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" id="ep">
	                      <tr> 
	                        <td align="right"> 
	                          <!-- 分类 -->
	                          <font color="#000000" size="2"><fmt:message key="resourceForm.resourceType"/>:</font></td>
	                        <td >
	                      ...
	                      <tr> 
	                        <td align="right"> 
	                          <!-- 启用 -->
	                          <font color="#000000" size="2"><fmt:message key="resourceForm.isValidate"/>:</font></td>
                        ...
                        <td nowrap="nowrap" class="dataLabel"> 
                          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                          	<tr>
		                        <td> 
		                          <!--显示顺序 -->
		                          <font color="#000000" size="2"><fmt:message key="orderCategoryForm.displayNo"/>:</font></td>
		                        <td ><input type="text" name="displayNo" id="displayNo" size="5" value=""></td>
	                      </tr>
	                      </table>
                          </td>
