	...
	<tbody>
	    <tr> 
		    <td width="50%" nowrap="nowrap" class="dataLabel">
		    	<fmt:message key="incomePurposeForm.name"/>:       	
	        </td>
	        <td>
	    ...
	    <tr> 
		    <td width="50%" nowrap="nowrap" class="dataLabel">
		    	<fmt:message key="incomePurposeForm.value"/>:       	
	        </td>
	        <td>
	 ...
	 <tr>
		<td>
			<div align="center">
		        ...
		        <html:submit styleClass="" property="method.delete" onclick="bCancel=true; return confirmDelete('IncomePurpose')">
