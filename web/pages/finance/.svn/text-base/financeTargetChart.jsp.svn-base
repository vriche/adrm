...
<script type="text/javascript" src="<c:url value='/scripts/finance/financeTargetChartService.js'/>"></script>



<content tag="heading"><fmt:message key="financeTargetAnalyze"/></content>
