...
<title><fmt:message key="carrierTarget"/></title>
...
<script type="text/javascript" src="<c:url value='/scripts/analyze/carrierTargetRatioService.js'/>"></script>

 

<content tag="heading"><fmt:message key="carrierTarget"/></content>
               		...
               		<div style="position:relative;overflow:visible">   
						...
						<div id="theDivSearch" style="position:absolute;  OVERFLOW: auto;left:0px;top:21px;width:550px;height:400px;visibility:hidden;border:solid green 2px;background-color:white;z-index:1">	
               			 ...
               			 <table width="100%">
			                 ...
			                 <tr>
			                 <td><div name="theDivCustomerName" id="theDivCustomerName"/>
