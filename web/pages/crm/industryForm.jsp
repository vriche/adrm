	...
	<tbody>
    	<tr> 
		    <td nowrap="nowrap" class="requiredInput">
		    	<fmt:message key="industryForm.code"/>:       	
	        </td>
	        <td>
    	...
    	<tr> 
		    <td nowrap="nowrap" class="requiredInput">
		    	<fmt:message key="industryForm.name"/>:       	
	        </td>
	        <td>
    	...
    	<tr> 
		    <td width="50%" nowrap="nowrap" class="dataLabel">
		    	<fmt:message key="industryForm.memo"/>:       	
	        </td>
	        <td>
		  ...
		  <tr>
		  	<td>
		  		<div align="center">
			        ...
			        <html:submit styleClass="" property="method.delete" onclick="bCancel=true; return confirmDelete('Industry')">
