	...
	<tbody>
	    <tr> 
		    <td nowrap="nowrap" class="requiredInput">
		    	<fmt:message key="customerTypeForm.name"/>:       	
	        </td>
	        <td>
	    ...
	    <tr> 
		    <td nowrap="nowrap" class="requiredInput">
		    	<fmt:message key="customerTypeForm.code"/>:       	
	        </td>
	        <td>
	    ...
	    <tr> 
		    <td width="50%" nowrap="nowrap" class="dataLabel">
		    	<fmt:message key="customerTypeForm.memo"/>:       	
	        </td>
	        <td>
	 ...
	 <tr>
		<td>
			<div align="center">
		        ...
		        <html:submit styleClass="" property="method.delete" onclick="bCancel=true; return confirmDelete('CustomerType')">
