...
<script type="text/javascript" src="<c:url value='/scripts/customer/customerCarrierRelService.js'/>"></script>
...
<table width="100%" height="130px" border="0" cellspacing="0" cellpadding="3" align="center">
  ...
  <table id="pageInfo_customerCarrierRel_table" width="100%" border="0" cellspacing="0" cellpadding="0">
							  				 <tr>
						                        ...
						                        <tr  bgcolor="#ffffff">
						                          <td align="right" height="15"> 
						                              &nbsp;<div id="pageInfo_customerCarrierRel"></div>
						                          </td>
						                     	</tr>
	</table>
	</div>
...
<select name="resource" id="resourceName"/>
</div>
</body>
</html>