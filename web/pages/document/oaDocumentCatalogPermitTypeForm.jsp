	...
	<tbody>
	    <tr> 
		    <td nowrap="nowrap" class="requiredInput">
		    	<fmt:message key="oaDocumentCatalogPermitTypeForm.name"/>:       	
	        </td>
	        <td>
	 ...
	 <tr>
		<td>
			<div align="center">
		        ...
		        <html:submit styleClass="" property="method.delete" onclick="bCancel=true; return confirmDelete('OaDocumentCatalogPermitType')">
