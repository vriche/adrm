    ...
    <td><table background="images/table1/textbox_top.gif" border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          <tr> 
			...
			<div id="theDivSearch" style="position:absolute;  OVERFLOW: auto;left:0px;top:21px;width:500px;height:400px;visibility:hidden;border:solid green 2px;background-color:white;z-index:0">	
				...
				<select name="select" id="carrierName"/>
	     		    ...
	     		    <td align="left">
	                  ...
	                  <tr>
	                   	...
	                   	<td align="left">
							<input size="12px" name="order_code" id="order_code" type=text  value="==<fmt:message key="orderDetailForm.orderId"/>==">		
	     		    	</td>
	     		    
	     		    	<td align="left">
							<input size="12px" name="contract_code" id="contract_code" type=text  value="==<fmt:message key="contractForm.code"/>==">
	     		    	</td>	
	                  
	                    <td align="left">
							<input type ="text" id ="relation_code" size=12 value="==<fmt:message key="orderForm.relationCode"/>=="/>		
	     		   		</td>
	                ...
	                <tr><td align="left" colspan="5">&nbsp</td></tr> 
                     ...
                     <input style="CURSOR: pointer;" type="button" id="btn_searche_close" value='&nbsp;&nbsp;&nbsp;&nbsp;<fmt:message key="button.cancel"/>&nbsp;&nbsp;&nbsp;&nbsp;'>
	                      ...
	                      <adrm_order:authorizeTag res="tag_orderList_new">	
	                      	<a href="#" id="Btn_addNewOrder" class="button">&nbsp;&nbsp;&nbsp;&nbsp;<fmt:message key="button.add"/>&nbsp;&nbsp;&nbsp;&nbsp;</a>   
	                      </adrm_order:authorizeTag>         
 	                      ...
 	                      <adrm_order:authorizeTag res="tag_orderList_print">	 
		 	                     &nbsp;&nbsp;&nbsp;&nbsp;
		 	                      <a href="#"  id="Btn_view_order"  class="button">&nbsp;&nbsp;&nbsp;&nbsp;<fmt:message key="publishedInfoForm.button.preView"/>&nbsp;&nbsp;&nbsp;&nbsp;</a>  
		 	                      <a href="#"  id="Btn_print_order"  class="button">&nbsp;&nbsp;&nbsp;&nbsp;<fmt:message key="publishedInfoForm.button.print"/>&nbsp;&nbsp;&nbsp;&nbsp;</a>  
		 	                      <a href="#"  id="Btn_export_order"  class="button">&nbsp;&nbsp;&nbsp;&nbsp;<fmt:message key="publishedInfoForm.button.export"/>&nbsp;&nbsp;&nbsp;&nbsp;</a>  
          ...
          <tr> 
			...
			<display:table name="orderList" cellspacing="1" cellpadding="0" decorator="com.vriche.adrm.webapp.util.orderTableDecorator" 
			    ...
			    export="false" requestURI="/orders.html">
			     ...
			     <display:column  title="<input type=checkbox onclick='selectAll' id=orderAllSelect>" 
