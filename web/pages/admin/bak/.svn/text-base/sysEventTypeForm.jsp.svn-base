...
<ul>
    ...
    <li>
        <adrm_order:label styleClass="desc" key="sysEventTypeForm.createBy"/>
    ...
    <li>
        <adrm_order:label styleClass="desc" key="sysEventTypeForm.createDate"/>
...
<html:hidden property="id"/>
    ...
    <li>
        <adrm_order:label styleClass="desc" key="sysEventTypeForm.modifyBy"/>
    ...
    <li>
        <adrm_order:label styleClass="desc" key="sysEventTypeForm.modifyDate"/>
    ...
    <li>
        <adrm_order:label styleClass="desc" key="sysEventTypeForm.name"/>
    ...
    <li>
        <adrm_order:label styleClass="desc" key="sysEventTypeForm.value"/>
...
<html:hidden property="version"/>
    ...
    <li class="buttonBar bottom">
        ...
        <html:submit styleClass="button" property="method.delete" onclick="bCancel=true; return confirmDelete('SysEventType')">
