...
<ul>
    ...
    <li>
        <adrm_order:label styleClass="desc" key="sysPromptModeForm.createBy"/>
    ...
    <li>
        <adrm_order:label styleClass="desc" key="sysPromptModeForm.createDate"/>
...
<html:hidden property="id"/>
    ...
    <li>
        <adrm_order:label styleClass="desc" key="sysPromptModeForm.modifyBy"/>
    ...
    <li>
        <adrm_order:label styleClass="desc" key="sysPromptModeForm.modifyDate"/>
    ...
    <li>
        <adrm_order:label styleClass="desc" key="sysPromptModeForm.name"/>
    ...
    <li>
        <adrm_order:label styleClass="desc" key="sysPromptModeForm.value"/>
...
<html:hidden property="version"/>
    ...
    <li class="buttonBar bottom">
        ...
        <html:submit styleClass="button" property="method.delete" onclick="bCancel=true; return confirmDelete('SysPromptMode')">
