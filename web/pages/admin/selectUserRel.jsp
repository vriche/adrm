...
<script type="text/javascript" src="<c:url value='/scripts/admin/userRelService.js'/>"></script>
  ...
  <tr>
    <td >
		 <table width="100%" border="0" cellpadding="0" cellspacing="0" style="display:none">
		  <tr>
		    <td width="33%">&nbsp;</td>
		    <td  width="33%" align="center"><fmt:message key="button.userRel"/></td>
		    <td align="right">
		       <a id="Btn_saveUserRel" class="button">&nbsp;&nbsp;&nbsp;<fmt:message key="button.save"/>&nbsp;&nbsp;&nbsp;</a>
