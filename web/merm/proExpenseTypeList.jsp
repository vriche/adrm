...
<script type="text/javascript" src="<c:url value='/scripts/merm/proExpenseTypeListService.js'/>"></script>
				...
				<fieldset style="width: 97%" id="branchList" > 
		         ...
		         <tr>
		          <td nowrap="nowrap" class="dataLabel" >
		          	<fmt:message key="proOrderForm.proProgramType"/><td><input name="proExpenseTypeName" id="proExpenseTypeName" type="text" size="15"></td>
		          </td>
		        </tr>
		          <tr>
...
proExpenseTypeId:<input name="proExpenseTypeId" type="text" id="proExpenseTypeId">
