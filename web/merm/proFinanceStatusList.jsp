...
<script type="text/javascript" src="<c:url value='/scripts/class/proExpenseProgram.js'/>"></script>
...
<script type="text/javascript" src="<c:url value='/scripts/merm/proFinanceStatusListService.js'/>"></script>

</head>
<input id="ctxPath" type="hidden" value="<c:url value="/"/>">   
<body>
<table width="100%" border="0" cellspacing="0" cellpadding="3" align="center" height="130px">
...
proCusName:<input name="proCusName" type="text" id="proCusName">
