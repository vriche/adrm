...
<script type="text/javascript" src="<c:url value='/scripts/merm/proProgramIncomeAnalyzeService.js'/>"></script>
   ...
   <td>
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tr>
	    ...
	    <table id="pageInfo_proIncome_table" width="100%" border="0" cellspacing="0" cellpadding="0">
  		<tr>
