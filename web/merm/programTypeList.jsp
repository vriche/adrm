...
<script type="text/javascript" src="<c:url value='/scripts/merm/programTypeListService.js'/>"></script>
				...
				<fieldset style="width: 97%" id="branchList" > 
		         ...
		         <tr>
		          <td nowrap="nowrap" class="dataLabel" >
		          	<fmt:message key="proOrderForm.proProgramType"/><td><input name="programTypeName" id="programTypeName" type="text" size="15"></td>
		          </td>
		        </tr>
		          <tr>
		          ...
		          <td nowrap="nowrap" class="dataLabel" align="right">   
		               <fmt:message key="resourceForm.proResourceId"/><td><div id="programTypeDiv" style="width:150px; height:20px;"></td>
		          </td>
...
programTypeId:<input name="programTypeId" type="text" id="programTypeId">
programTypeParentId:<input name="programTypeParentId" type="text" id="programTypeParentId">
