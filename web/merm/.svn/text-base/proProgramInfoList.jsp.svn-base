...
<script type="text/javascript" src="<c:url value='/scripts/merm/proProgramInfoListService.js'/>"></script>
</head>
...
<table width="100%" height="130px" border="0" cellspacing="0" cellpadding="3" align="center">
 ...
 <tr>
<td>
<div id="toolbar_zone" style="width:100%;border :0px solid Silver;"/>
</td>
<tr>
