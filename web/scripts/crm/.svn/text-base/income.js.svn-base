...
var cellFunctions_Income = [
 	function(Income) { return "<a href='editIncome.html?id=" +Income.id +"'>" + formatDate(Income.incomeDate) +"</a>"},
 	function(Income) { return Income.IncomeCode },
    function(Income) { return Income.incomeMoney },
    function(Income) { return Income.incomeMode.name },
    function(Income) { return Income.incomePurpose.name },
