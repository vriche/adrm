...
function button_addAgentInfo(){
    ...
    td3.innerHTML = "<input type=\"text\"  id=\"beginDate\"  readonly=\"true\" onclick=\"button_showdate('beginDate','anchorBeginDate')\"/> " +
                    "<span id=\"anchorBeginDate\" name=\"anchorBeginDate\"></span>";
    
    td4.innerHTML = "<input type=\"text\"  id=\"endDate\"  readonly=\"true\" onclick=\"button_showdate('endDate','anchorEndDate')\"/> " +
...
var cellFunctions_agentInfo = [
 	...
 	function(agentInfo) { return agentInfo.agentRate*100 +"%" },
 	function(agentInfo) { return formatDate(agentInfo.beginDate) },
    function(agentInfo) { return formatDate(agentInfo.endDate) },
