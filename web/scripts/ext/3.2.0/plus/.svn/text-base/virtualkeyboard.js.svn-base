...
Ext.ux.VirtualKeyboard = Ext.extend(Ext.Component, {
	...
	initComponent : function(options){
		...
		Ext.apply(this, {
			...
			closeKeysButtonText: this.closeKeysButtonText || 'Close',
	...
	initKeyboard : function(ct){
		...
		if(this.showKeyboardtbar){
			...
			if(this.showCloseButton){
					ktbarItems.push('-', new Ext.Button({
						text: this.closeKeysButtonText || 'Close',
						listeners: {
							'click': this.keyboardTarget.collapseKeyboard.createDelegate(this.keyboardTarget),
							scope: this
						},
						scope: this
					}));
