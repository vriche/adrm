...
function resetHeigth(){
	...
	$("gridbox_incomePull_div").style.height = dialogcontent.offsetHeight * 0.25 +"px";	
	$("gridbox_payment_div").style.height = dialogcontent.offsetHeight * 0.35 +"px";
} 
...
function initGrid_incomPull(){
	...
	mygrid_pull.setInitWidthsP("5,15,15,15,13,13,13,13");
	...
	mygrid_pull.setColTypes("ch,ro,ro,link,ro,ro,ro,ro");
...
function buttonEventFill(){
	...
	btn_search.onclick = saveIncomeUsed;
	
	var btn_putBack = $("btn_putBack");
	btn_putBack.onclick = saveIncomeUsed;
...
function getPayments(){ 
	...
	if(channelParam == 0) payment.obj.carrierIds = new Array();
