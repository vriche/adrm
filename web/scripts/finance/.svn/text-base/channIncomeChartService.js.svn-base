...
//	var srcStr = decodeURI(window.location.search);
	...
	var start = getParamFromUrl(srcStr,"start");
	var end = getParamFromUrl(srcStr,"end");
	...
	FusionChartsManager.getChannIncomeChartObjs(orgId,start,end,customerId,carrierId,channelModelParam,userName,isPutYear,isNotReturnValue,purpose,userId,func);
...
function renderFromQS(){
	...
	//Data 及 lable 
	//列名
	FCharts.LabelsData.cols =["客户名称","到账金额"];
	//显示列
