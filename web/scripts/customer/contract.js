...
function button_addContract(e){
	var s =  checkEeitStates();
	if (!s) return false;
	location.href="editContract.html";
//	e.href = "editContract.html";
//	e.parent.target = "_bank";
}
...
var cellFunctions_Contract = [
    ...
    function(Contract) { return Contract.startDate },
    function(Contract) { return Contract.endDate },
