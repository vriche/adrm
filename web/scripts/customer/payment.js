...
var cellFunctions_Payment = [
  	function(Payment) { return Payment.payDate},
  	function(Payment) { return Payment.payNumber },
  	function(Payment) { return  "<a href='editContract.html?id=" +Payment.contractId +"'>" + Payment.contractId +"</a>"},
  	function(Payment) { return  "<a href='editOrder.html?id=" +Payment.orderId +"'>" + "" +"</a>"},
