...
dhtmlXTreeObject.prototype._deleteItem=function(itemId,selectParent,skip){
 ...
 var sNode=this._globalIdStorageFind(itemId);
 if(!sNode)return;
 if(selectParent)this.selectItem(this.getParentId(itemId),1);
 else
...
dhtmlXTreeObject.prototype._createDragNode=function(htmlObject,e){
 ...
 dragSpan.innerHTML=this.getSelectedItemText().split(this.dlmtr).join("<br/>");
 ...
 if(!tobj)
{
 ...
 if((!this._onDrInFunc)||(this._onDrInFunc(fobj.id,tobj.id)))
{
...
dhtmlXTreeObject.prototype.setIconSize=function(newWidth,newHeight,itemId)
{
 ...
 dhtmlXTreeObject.prototype.enableMultiselection=function(mode){
