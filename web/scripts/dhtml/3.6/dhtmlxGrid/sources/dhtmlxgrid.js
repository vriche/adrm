...
//	_in_header_master_checkbox:function(tag,index,data){            // the name contains "_in_header_"+shortcut_name
//          tag.innerHTML=data[0]+"<input type='checkbox' />"+data[1];  // HTML view
