...
function init(){
	...
	$("caption").value = "客户订单类别统计";
	
	//如果 args2="" 则不显示
	var  args2 ="刊例总价,投放金额,优惠金额,时间";
...
//	var srcStr = decodeURI(window.location.search);
	...
	var customerIds = getParamFromUrl(srcStr,"customerIds").split(",");
	...
	FusionChartsManager.getOrderCarrierChartObjs(sortStr,year,startDate,endDate,customerIds,userId,carrierName,channelModelParam,userName,func);
