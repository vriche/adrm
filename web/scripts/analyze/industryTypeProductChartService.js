...
//	var srcStr = decodeURI(window.location.search);
	...
	FusionChartsManager.getIndustryTypeChartObjs(channelModelParam,beginDate,endDate,userId,carrierName,userName,isPrint,func);
...
function renderFromQS(objs,name,divName){
	...
	FCharts.LabelsData.parentYAxisS =[3];	
		...
		FCharts.LabelsData.cols =["客户名称","投放金额",,,"投放比例"];
		//parentYAxis=P
