...
//	var srcStr = decodeURI(window.location.search);
	...
	var orderCategoryId = getParamFromUrl(srcStr,"orderCategoryId");


	FusionChartsManager.getCarrierScopeChartObjs(startDate,endDate,carrierIds,userId,userName,isPrint,orderCategoryId,func);
