...
//	var srcStr = decodeURI(window.location.search);
	...
	FusionChartsManager.getCarrierAllChartObjs(year, carrierIds, userId, userName,isPrint,isType,func);
}
...
//	FCharts.Chart.chartdiv = "chartdiv";
	...
	//Data 及 lable 
	//列名
	FCharts.LabelsData.cols =["载体","一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"];
	//显示列
