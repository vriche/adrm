...
//	var srcStr = decodeURI(window.location.search);
	...
	FusionChartsManager.getCarrierBasalChartObjs(channelModelParam,beginDate,endDate,userId,carrierName,userName,isPrint,func);
