...
//	var srcStr = decodeURI(window.location.search);
	...
	FusionChartsManager.getYearTargetChartObjs(channelModelParam,size,type,isPutYear,isNotReturnValue,carrierId,userName,purpose,func);
...
function renderFromQS(objs,name,divName){
	...
	FCharts.LabelsData.cols.push("频道名称");
