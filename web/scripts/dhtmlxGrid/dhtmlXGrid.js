...
dhtmlXGridObject.setOnRowDblClickedHandler = function(func){
 ...
 if(xml.getAttribute("locked"))
{
 ...
 dhtmlXGridObject.prototype.setOnLoadingStart=function(func){if(typeof(func)=="function")this.onXLS=func;else this.onXLS=eval(func);};
 
 dhtmlXGridObject.prototype.setOnLoadingEnd=function(func){if(typeof(func)=="function")this.onXLE=func;else this.onXLE=eval(func);};
