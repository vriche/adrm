...
<%
		...
		String carrierIdForm = request.getParameter("carrierIdForm");
		...
		request.getSession().setAttribute("carrierIdForm",carrierIdForm); 
...
<APPLET  name="broReport1"  CODE ="PublishViewerApplet.class" CODEBASE ="../applets" ARCHIVE ="jasperreports-1.2.8-applet.jar,report.jar" WIDTH ="100%" HEIGHT ="100%"></XMP>
    ...
    <PARAM NAME ="REPORT_URL" VALUE ="../yearTarget">
</APPLET>
<%}%>
...
if(model.equals("export")){
	response.sendRedirect("../../reports/yearTarget");
}
%>
