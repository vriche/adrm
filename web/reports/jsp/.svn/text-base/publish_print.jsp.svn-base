...
<APPLET  name="mytest2"  CODE ="PublishPrintApplet.class" CODEBASE ="../applets" ARCHIVE ="jasperreports-1.2.8-applet.jar,report.jar" WIDTH ="0" HEIGHT ="0"></XMP>
...
if(model.equals("export")){
	response.sendRedirect("../../reports/printPublish");
}
%>
